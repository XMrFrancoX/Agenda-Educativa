...
<svelte:head>
	<title>Panel de Super Admin — Agenda Educativa</title>
</svelte:head>

<div class="page-header">
	<div class="page-header-content">
		<div>
			<h1 class="page-title">Centro de Control Global</h1>
			<p class="page-subtitle">Panel exclusivo para Super Administradores. Gestioná escuelas y cuentas de usuario.</p>
		</div>
	</div>
</div>
